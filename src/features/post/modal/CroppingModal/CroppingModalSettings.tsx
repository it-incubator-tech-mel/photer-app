    ...
    <div className="flex justify-between gap-4">
      ...
      >
        <Slider
          ...
          step={0.1}
          value={[zoom]}
          onValueChange={(e) => onZoomChange(e[0])}
          className="w-[100px]"
        />
      </SettingControl>
      ...
      <SettingControl
        ...
        onToggle={() => onToggleSetting('rotation')}
      >
        <Slider
          defaultValue={[0]}
          min={0}
          max={360}
          value={[rotation]}
          onValueChange={(e) => onRotationChange(e[0])}
          className="w-[100px]"
        />
      </SettingControl>
      ...
      <SettingControl
        ...
        onToggle={() => onToggleSetting('ratio')}
